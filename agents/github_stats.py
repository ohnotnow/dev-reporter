...
class GithubStatsAgent():
    def __init__(self, repo: Repository):
        self.repo = repo

    def run(self) -> GithubStats:
    ...
    def get_stats(self) -> GithubStats:
        ...
        closed_issues = self.repo.get_issues(state="closed", since=thirty_days_ago)
        ...
        merged_prs = self.repo.get_pulls(state="closed")
        ...
        # Dependabot alerts: use GitHub API - some repo's don't have dependabot enabled
        try:
        ...
        try:
            ...
            # note: some repos don't have dependabot enabled, but pygithub only throws
            # an exception when it lazily tries to access the dependabot alerts
            pass
